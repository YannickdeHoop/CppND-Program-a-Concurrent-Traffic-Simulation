...
public:
  ...
  std::vector<std::shared_ptr<Street>> queryStreets(std::shared_ptr<Street> incoming);  // return pointer to current
                                                                                        // list of all outgoing streets
  void simulate();
...
private:
  ...
  WaitingVehicles _waitingVehicles;  // list of all vehicles and their associated promises waiting to enter the
                                     // intersection
